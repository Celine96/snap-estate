                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/60 backdrop-blur-sm">
                  ...
                  <div className="flex gap-2 mt-4">
                    <button
                      ...
                      className="px-4 py-2 rounded-lg bg-blue-600 text-white text-sm font-semibold hover:bg-blue-500 transition-all"
                    >
                      같은 이미지로 재시도
                    </button>
                    <button
                      onClick={(e) => { e.stopPropagation(); clearImage(); }}
                      className="px-4 py-2 rounded-lg bg-white/10 border border-white/20 text-white/80 text-sm hover:bg-white/20 transition-all"
                    >
                      다른 이미지 선택
                    </button>
                  </div>
